...
import com.cafe.democom.cafe.dao.BillDao;
import com.cafe.democom.cafe.service.BillService;
...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
           String fileName;  //used for uniquely identify a particular pdf
    ...
    public ResponseEntity<List<Bill>> getBills() {
        ...
        if(jwtFilter.isAdmin()) {
           list = billDao.getAllBills();
            ...
            //not admin, only shows bills of that user
    ...
    public ResponseEntity<byte[]> getPdf(Map<String, Object> requestMap) {
        log.info("inside getpdf: requestMap{}", requestMap); //helps when debugging
        try {
